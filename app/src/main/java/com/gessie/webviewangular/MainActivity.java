package com.gessie.webviewangular;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.gessie.webviewangular.WebAppInterface webAppInterface = new WebAppInterface(MainActivity.this, this);
    ...
    public void showNotification() {
        ...
        NotificationChannel channel = new NotificationChannel("twChannel", "T", NotificationManager.IMPORTANCE_DEFAULT);
